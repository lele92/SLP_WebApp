myApp.controller('ArticlesOrderbyController', ["CitationsFiltersManagerService","ORDER_BY","ArticlesFiltersManager", function(CitationsFiltersManagerService,ORDER_BY,ArticlesFiltersManager) {
	var self = this;
