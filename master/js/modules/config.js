...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, appRequires) {
  ...
  $stateProvider
    ...
    .state('app.form-extended', {
        ...
        controller: 'NullController',
        resolve: resolveFor('codemirror', 'codemirror-plugins', 'moment', 'taginput','inputmask','angular-chosen', 'slider', 'ngWig', 'filestyle')
    })
    ...
    .state('app.search', {
        ...
        controller: 'NullController',
        resolve: resolveFor('moment', 'angular-chosen', 'slider')
    })
    .state('app.todo', {
        url: '/todo',
        title: 'Todo List',
